...
<p class="form-field">
	<label for="subscriptions_discounts_regular_price-<?php echo esc_attr( $role ); ?>"><?php esc_attr_e( 'Regular price', 'discounts-for-woocommerce-subscriptions' ); ?></label>

	<input type="text"
		   value="<?php echo esc_attr( wc_format_localized_price( $regular_price ) ); ?>"
		   class="wc_input_price"
		   id="subscriptions_discounts_regular_price-<?php echo esc_attr( $role ); ?>"
		   name="subscriptions_discounts_regular_price[<?php echo esc_attr( $role ); ?>]">
</p>

<p class="form-field">
	<label for="subscriptions_discounts_sale_price-<?php echo esc_attr( $role ); ?>"><?php esc_attr_e( 'Sale price', 'discounts-for-woocommerce-subscriptions' ); ?></label>

	<input type="text"
		   value="<?php echo esc_attr( wc_format_localized_price( $sale_price ) ); ?>"
		   class="wc_input_price"
		   id="subscriptions_discounts_sale_price-<?php echo esc_attr( $role ); ?>"
		   name="subscriptions_discounts_sale_price[<?php echo esc_attr( $role ); ?>]">
</p>
...
<p class="form-field">
	...
	<select name="subscriptions_discounts_rules_type_roles[<?php echo esc_attr( $role ); ?>]"
				...
				<span data-discounts-rules-container>
					<span data-price-rules-input-wrapper>
						<input type="number" value="<?php echo esc_attr( $amount ); ?>" min="1"
							   ...
							   name="subscriptions_discounts_fixed_quantity_roles[<?php echo esc_attr( $role ); ?>][]">
						<input type="text" value="<?php echo esc_attr( wc_format_localized_price( $price ) ); ?>"
							   ...
							   name="subscriptions_discounts_fixed_price_roles[<?php echo esc_attr( $role ); ?>][]">
					</span>
				...
				<span data-discounts-rules-container>
					<span data-price-rules-input-wrapper>
						<input type="number" value="<?php echo esc_attr( $amount ); ?>" min="1"
							   placeholder="<?php esc_attr_e( 'Renewal sequence number', 'discounts-for-woocommerce-subscriptions' ); ?>"
							   class="price-quantity-rule price-quantity-rule--simple"
							   name="subscriptions_discounts_percent_quantity_roles[<?php echo esc_attr( $role ); ?>][]">
						<input type="number" value="<?php echo esc_attr( $discount ); ?>" max="99"
							   ...
							   step="any"
							   name="subscriptions_discounts_percent_discount_roles[<?php echo esc_attr( $role ); ?>][]">
					</span>
					<span class="notice-dismiss remove-discount-rule" data-remove-discount-rule></span>
					<br>
					<br>
