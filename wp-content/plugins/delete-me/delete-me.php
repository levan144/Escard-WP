...
/*
Copyright (c) 2011-2023 - Clinton Caldwell <clint3215@gmail.com>
	...
	private function default_option() {
		...
		return array(
			'settings' => array(
				...
				'your_profile_confirm_warning' => 'WARNING!<br /><br />Are you sure you want to delete account from %sitename%?',
				...
				'shortcode_js_confirm_warning' => 'WARNING!\n\nAre you sure you want to delete account from %sitename%?',
				'shortcode_js_confirm_enabled' => true,
				'shortcode_form_enabled' => false,
				'shortcode_form_confirm_warning' => 'WARNING!<br /><br />Are you sure you want to delete account from %sitename%?',
