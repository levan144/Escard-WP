 ...
 * @version   1.2.0
 */
if ( ! class_exists( 'MOSS_Template_Loader' ) ) {
	/**
	 * Template loader.
	 *
	...
	class MOSS_Template_Loader {
		 ...
		 * @var string
		 */
		protected $filter_prefix = 'mofect_';
		/**
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'mofect-core/templates/on-site-search';
		/**
		 ...
		 * @var string
		 */
		protected $plugin_directory = MOSS_DIR;
		/**
