...
*/
/**
 * Class TMVC_CMB2_Field_Post_Search_Ajax
 */
if( ! class_exists( 'TMVC_CMB2_Field_Post_Search_Ajax' ) ) {
...
$tmvc_field_post_search_ajax = new TMVC_CMB2_Field_Post_Search_Ajax();